...
@router.get("/{programacion_id:int}", response_model=ProgramacionSchema)
...
@router.put("/{programacion_id:int}", response_model=ProgramacionSchema)
...
@router.delete("/{programacion_id:int}")
