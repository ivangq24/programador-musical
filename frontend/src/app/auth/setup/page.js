        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-8 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <h1 className="text-3xl font-bold text-white mb-2">Crear Cuenta de Administrador</h1>
              <p className="text-blue-100 text-sm">
                Gestiona tu grupo de radiodifusoras
              </p>
            </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-6 text-center text-sm text-gray-600">
              <p className="font-semibold text-gray-700 mb-2">Creando tu nueva organización</p>
              <p>Cada administrador gestiona su propio grupo de radiodifusoras independiente.</p>
              <p className="mt-1">Después de crear tu cuenta, podrás:</p>
              <ul className="mt-2 text-left list-disc list-inside space-y-1 text-gray-600">
                <li>Crear y gestionar tus difusoras</li>
                <li>Configurar políticas de programación</li>
                <li>Invitar a otros administradores a tu organización</li>
