...
export const getCortes = async (params = {}) => {
  try {
    const response = await apiClient.get('/catalogos/cortes/', { params })
...
export const getCorte = async (id) => {
  try {
    const response = await apiClient.get(`/catalogos/cortes/${id}`)
    return response.data
  } catch (error) {
...
export const createCorte = async (corteData) => {
  try {
    const response = await apiClient.post('/catalogos/cortes/', corteData)
    return response.data
  } catch (error) {
...
export const updateCorte = async (id, corteData) => {
  try {
    const response = await apiClient.put(`/catalogos/cortes/${id}`, corteData)
    return response.data
  } catch (error) {
...
export const deleteCorte = async (id) => {
  try {
    const response = await apiClient.delete(`/catalogos/cortes/${id}`)
    return response.data
  } catch (error) {
...
export const getCortesStats = async () => {
  try {
    const response = await apiClient.get('/catalogos/cortes/stats/summary')
    return response.data
  } catch (error) {
